...
let typed (sk: Libcrux_kem.t_PrivateKey) (pk: Libcrux_kem.t_PublicKey)
  ...
  then
    ...
    | Core_models.Result.Result_Ok hoist5 ->
      let private_key:t_MLKEM768PrivateKey = impl_MLKEM768PrivateKey__from_bytes hoist5 in
      (match
        ...
        | Core_models.Result.Result_Ok hoist6 ->
          let public_key:t_MLKEM768PublicKey = impl_MLKEM768PublicKey__from_bytes hoist6 in

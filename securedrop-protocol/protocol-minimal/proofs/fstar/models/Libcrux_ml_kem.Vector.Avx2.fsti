...
type t_SIMD256Vector = { f_elements:Core_models.Abstractions.Bitvec.t_BitVec (mk_u64 256) }

let repr (x:t_SIMD256Vector) : t_Array i16 (sz 16) = Libcrux_intrinsics.Avx2_extract.vec256_as_i16x16 x.f_elements

let impl_1: Core_models.Clone.t_Clone t_SIMD256Vector =
  { f_clone = (fun x -> x); f_clone_pre = (fun _ -> True); f_clone_post = (fun _ _ -> True) }

[@@ FStar.Tactics.Typeclasses.tcinstance]
val impl_2:Core_models.Marker.t_Copy t_SIMD256Vector

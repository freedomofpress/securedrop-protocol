...
val deserialize_1_ (a: t_Slice u8)
    : Prims.Pure Libcrux_ml_kem.Vector.Portable.Vector_type.t_PortableVector
      (requires (Core_models.Slice.impl__len #u8 a <: usize) =. mk_usize 2)
      (ensures
        fun out ->
...
val deserialize_4_ (a: t_Slice u8)
    : Prims.Pure Libcrux_ml_kem.Vector.Portable.Vector_type.t_PortableVector
      (requires (Core_models.Slice.impl__len #u8 a <: usize) =. mk_usize 8)
      (ensures
        fun out ->
          let out:Libcrux_ml_kem.Vector.Portable.Vector_type.t_PortableVector = out in
...
val deserialize_5_ (a: t_Slice u8)
    : Prims.Pure Libcrux_ml_kem.Vector.Portable.Vector_type.t_PortableVector
      (requires (Core_models.Slice.impl__len #u8 a <: usize) =. mk_usize 10)
      (fun _ -> Prims.l_True)
...
val deserialize_10_ (a: t_Slice u8)
    : Prims.Pure Libcrux_ml_kem.Vector.Portable.Vector_type.t_PortableVector
      (requires (Core_models.Slice.impl__len #u8 a <: usize) =. mk_usize 20)
      (ensures
        fun out ->
          let out:Libcrux_ml_kem.Vector.Portable.Vector_type.t_PortableVector = out in
...
val deserialize_11_ (a: t_Slice u8)
    : Prims.Pure Libcrux_ml_kem.Vector.Portable.Vector_type.t_PortableVector
      (requires (Core_models.Slice.impl__len #u8 a <: usize) =. mk_usize 22)
      (fun _ -> Prims.l_True)
...
val deserialize_12_ (a: t_Slice u8)
    : Prims.Pure Libcrux_ml_kem.Vector.Portable.Vector_type.t_PortableVector
      (requires (Core_models.Slice.impl__len #u8 a <: usize) =. mk_usize 24)
      (ensures
        fun out ->
          let out:Libcrux_ml_kem.Vector.Portable.Vector_type.t_PortableVector = out in

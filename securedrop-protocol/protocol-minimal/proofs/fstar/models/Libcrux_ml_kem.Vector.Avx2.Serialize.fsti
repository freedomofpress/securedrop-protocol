...
val serialize_1_ (vector: Core_models.Abstractions.Bitvec.t_BitVec (mk_u64 256))
...
val deserialize_1___deserialize_1_i16s (a b: i16)
    : Prims.Pure (Core_models.Abstractions.Bitvec.t_BitVec (mk_u64 256))
      ...
      (ensures
        fun coefficients ->
          let coefficients:Core_models.Abstractions.Bitvec.t_BitVec (mk_u64 256) = coefficients in
          forall (i: nat{i < 256}).
            coefficients i =
            (if i % 16 >= 1
              then 0
...
val deserialize_1_ (bytes: t_Slice u8)
    : Prims.Pure (Core_models.Abstractions.Bitvec.t_BitVec (mk_u64 256))
      (requires (Core_models.Slice.impl__len #u8 bytes <: usize) =. mk_usize 2)
      (ensures
        fun coefficients ->
          let coefficients:Core_models.Abstractions.Bitvec.t_BitVec (mk_u64 256) = coefficients in
          forall (i: nat{i < 256}).
...
val serialize_4_ (vector: Core_models.Abstractions.Bitvec.t_BitVec (mk_u64 256))
...
val serialize_5_ (vector: Core_models.Abstractions.Bitvec.t_BitVec (mk_u64 256))
...
val serialize_10___serialize_10_vec (vector: Core_models.Abstractions.Bitvec.t_BitVec (mk_u64 256))
    : Prims.Pure
      ...
      (ensures
        fun temp_0_ ->
          let
          (lower_8_: Core_models.Abstractions.Bitvec.t_BitVec (mk_u64 128)),
          (upper_8_: Core_models.Abstractions.Bitvec.t_BitVec (mk_u64 128)) =
            temp_0_
          in
          forall (i: nat{i < 160}).
            vector ((i / 10) * 16 + i % 10) == (if i < 80 then lower_8_ i else upper_8_ (i - 80)))

val serialize_10_ (vector: Core_models.Abstractions.Bitvec.t_BitVec (mk_u64 256))
...
val deserialize_10___deserialize_10_vec
      (lower_coefficients0 upper_coefficients0:
          Core_models.Abstractions.Bitvec.t_BitVec (mk_u64 128))
    : Prims.Pure (Core_models.Abstractions.Bitvec.t_BitVec (mk_u64 256))
      Prims.l_True
      (ensures
...
val serialize_11_ (vector: Core_models.Abstractions.Bitvec.t_BitVec (mk_u64 256))
...
val serialize_12___serialize_12_vec (vector: Core_models.Abstractions.Bitvec.t_BitVec (mk_u64 256))
    : Prims.Pure
      (Core_models.Abstractions.Bitvec.t_BitVec (mk_u64 128) &
        Core_models.Abstractions.Bitvec.t_BitVec (mk_u64 128))
...
val serialize_12_ (vector: Core_models.Abstractions.Bitvec.t_BitVec (mk_u64 256))

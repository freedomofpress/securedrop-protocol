      ...
      (ensures
        fun myself_future ->
          ...
          forall (i: nat).
            ...
            (let lhs_i = i0.f_to_i16_array (myself.f_coefficients.[ sz i ]) in
              let rhs_i = i0.f_to_i16_array (rhs.f_coefficients.[ sz i ]) in
              let result_i = i0.f_to_i16_array (myself_future.f_coefficients.[ sz i ]) in
    ...
    : Prims.Pure v_T
      ...
      (ensures
        fun result ->
          ...
          Spec.Utils.is_i16b_array 3328 (i0.f_to_i16_array result) /\
          (forall i.
              i < 16 ==>
              ((v (Seq.index (i0.f_to_i16_array result) i) % 3329) ==

...
type t_PublicKey = | PublicKey : t_Array u8 (mk_usize 32) -> t_PublicKey
...
type t_SharedSecret = | SharedSecret : t_Array u8 (mk_usize 32) -> t_SharedSecret

module Securedrop_protocol.Primitives.Xwing
...
assume
val impl_2': Core_models.Fmt.t_Debug t_XWingPublicKey

unfold
let impl_2 = impl_2'

let impl_3: Core_models.Clone.t_Clone t_XWingPublicKey =
...
[@@ FStar.Tactics.Typeclasses.tcinstance]
assume
val impl_4': Core_models.Fmt.t_Debug t_XWingPrivateKey

unfold
let impl_4 = impl_4'

let impl_5: Core_models.Clone.t_Clone t_XWingPrivateKey =
  { f_clone = (fun x -> x); f_clone_pre = (fun _ -> True); f_clone_post = (fun _ _ -> True) }
  ...
  | Core_models.Result.Result_Ok (sk, pk) ->
    ...
    then
      ...
      (match
        ...
        with
        | Core_models.Result.Result_Ok hoist40 ->
          let private_key:t_XWingPrivateKey = impl_XWingPrivateKey__from_bytes hoist40 in
          (match
            ...
            | Core_models.Result.Result_Ok hoist41 ->
              let public_key:t_XWingPublicKey = impl_XWingPublicKey__from_bytes hoist41 in
    ...
    then
      ...
      (match
        ...
        | Core_models.Result.Result_Ok hoist45 ->
          let private_key:t_XWingPrivateKey = impl_XWingPrivateKey__from_bytes hoist45 in
          (match
              Core_models.Result.impl__map_err #(t_Array u8 (mk_usize 1216))
                #(Alloc.Vec.t_Vec u8 Alloc.Alloc.t_Global)
                #Anyhow.t_Error
              ...
              Core_models.Result.t_Result (t_Array u8 (mk_usize 1216)) Anyhow.t_Error
            with
            | Core_models.Result.Result_Ok hoist46 ->
              let public_key:t_XWingPublicKey = impl_XWingPublicKey__from_bytes hoist46 in

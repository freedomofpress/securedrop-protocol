...
def get_fetch():
    ...
    for message_key in message_keys:
        ...
        # calculate the shared key for message_id encryption
    ...
    # padding to hide the number of messages to be added later
...
def send():
    ...
    message_dict = {
        ...
        # gj, public key part of the keypair generated by the sending journalist for every message
        "message_public_key": request.json["message_public_key"],
        # gkj, public part computed using the source public key and the per-message secret key

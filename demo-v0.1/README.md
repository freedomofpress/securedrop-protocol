# SecureDrop Protocol 0.1

This is the original Securedrop Protocol proof-of-concept implementation that was published in May 2024 along with [this blog post announcement](https://securedrop.org/news/introducing-securedrop-protocol).

## Directory overview

The code in this directory implements three components:

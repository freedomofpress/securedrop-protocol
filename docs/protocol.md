...
|                                                                                                           |                                                                       | $`\sigma_{NR,J} \gets^{\$} \text{SIG.Sign}(sk_{NR}^{sig}, \texttt{nr-sig-j} \Vert vk_J^{sig})`$        |
...
| If $`\text{SIG.Vfy}(vk_{NR}^{sig}, \texttt{nr-sig-j} \Vert vk_J^{sig}, \sigma_{NR,J}) = 0`$ for some $J$: abort                            |                                 |                                                                                                                 |
